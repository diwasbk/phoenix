                    ...
                    {isMenuOpen && (
                        <div className="md:hidden bg-white border-t border-gray-200/50 animate-slide-down">
                            <div className="px-2 pt-2 pb-4 space-y-2">
                                ...
                                <Link
                                    href={"/apply"}
                                    className="block w-full mt-4 bg-linear-to-r from-blue-600 to-blue-700 text-white px-4 py-3 rounded-lg text-center font-bold uppercase text-sm tracking-wide hover:from-blue-700 hover:to-blue-800 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/50 transform hover:scale-105"
                                    onClick={() => setIsMenuOpen(false)}
                                >
                                    Get Started
                                </Link>
