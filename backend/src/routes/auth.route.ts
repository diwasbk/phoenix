...
authRouter.delete("/delete-account/:userId", jwtAuthMiddleware, schemaValidateMiddleware(loginSchema.pick({ password: true })), authController.deleteUserAccountByUserId)
